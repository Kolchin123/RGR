...
public class AccessControlAspectsUser {
	...
	@Around("execution(* com.pkm.quizzz.repository.UserRepository.save(..)) && args(user)")
	...
	@Around("execution(* com.pkm.quizzz.repository.UserRepository.find(Long)) && args(id)")
	...
	@Around("execution(* com.pkm.quizzz.repository.UserRepository.findAll())")
	...
	@Around("execution(* com.pkm.quizzz.repository.UserRepository.delete(..)) && args(user)")
