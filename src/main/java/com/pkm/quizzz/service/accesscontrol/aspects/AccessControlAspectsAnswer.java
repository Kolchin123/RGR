...
public class AccessControlAspectsAnswer {
	...
	@Around("execution(* com.pkm.quizzz.repository.AnswerRepository.save(..)) && args(answer)")
	...
	@Around("execution(* com.pkm.quizzz.repository.AnswerRepository.find(Long)) && args(id)")
	...
	@Around("execution(* com.pkm.quizzz.repository.AnswerRepository.findAll())")
	...
	@Around("execution(* com.pkm.quizzz.repository.AnswerRepository.delete(..)) && args(answer)")
