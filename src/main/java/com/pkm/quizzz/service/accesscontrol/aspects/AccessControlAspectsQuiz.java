...
public class AccessControlAspectsQuiz {
	...
	@Around("execution(* com.pkm.quizzz.repository.QuizRepository.save(..)) && args(quiz,..)")
	...
	@Around("execution(* com.pkm.quizzz.repository.QuizRepository.find(Long)) && args(id)")
	...
	@Around("execution(* com.pkm.quizzz.repository.QuizRepository.findAll())")
	...
	@Around("execution(* com.pkm.quizzz.repository.QuizRepository.delete(..)) && args(quiz)")
